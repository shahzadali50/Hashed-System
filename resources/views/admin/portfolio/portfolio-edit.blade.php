            ...
            <form action="{{ route('admin.portfolio-update',$portfolio->id) }}" method="POST"  enctype="multipart/form-data">
                @csrf
                   ...
                   <div class="form-group row mb-2">
                    <div class="col-md-3">
                        ...
                        <div>
                            ...
                            <img style="width: 150px; height: 150px;" src="{{ asset('storage/'.$portfolio->image) }}" alt="not-show">
                        </div>
                    </div>
                    <div class="col-md-8">
                   ...
                   <div class="form-group row mb-2">
                    ...
                    <div class="col-md-8">
                        <input type="text" value="{{ $portfolio->title }}"  name="title" placeholder="Portfolio Name" class="form-control @error('title') is-invalid @enderror">
                   ...
                   <div class="form-group row mb-2">
                    ...
                    <div class="col-md-8">
                        <input type="text" value="{{ $portfolio->description }}"  name="description" placeholder="Portfolio Name" class="form-control @error('description') is-invalid @enderror">
                ...
                <div class="col-12 text-end mt-4">
                    <a class="btn btn-info" href="{{ route('admin.portfolio-list',$portfolio->category->id) }}">Back</a>
