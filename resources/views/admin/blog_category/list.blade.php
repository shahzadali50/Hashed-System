                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex align-items-center">
                                <form action="{{ route('admin.blog.categories.delete', $category->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this?');">
                                    @csrf
                                    @method('DELETE')
                                ...
                                <a href="{{ route('admin.blog.category.edit',$category->id) }}" class="btn btn-info btn-sm mx-1" data-bs-toggle="tooltip" title="Edit">
                                    <i class="fa fa-pencil"></i>
                                </a>
                                <a href="{{ route('admin.blog.create',$category->id) }}" class="btn btn-success btn-sm mx-1" data-bs-toggle="tooltip" title="Add Blog">
                                ...
                                <a href="{{ route('admin.blog.list',$category->id) }}}" class="btn btn-primary btn-sm mx-1" data-bs-toggle="tooltip" title="Blog List">
